...
![Drawing 1.png](./images/Cgp9HWCaW2OAYlzHAADXaDdFHb8485.png)
...
![Drawing 3.png](./images/Cgp9HWCaW3CAdvInAADIWAQSIV8394.png)
...
![Drawing 4.png](./images/Cgp9HWCaW4SATCCeAAEZWCOedLE293.png)
...
##### *鑫：
> 提供一个newBuilder()方法返回一个builder对象，如果有缺失或者要改造就可以调用这个方法返回现有的builder对象
...
##### *博：
> 设计时,让对象builder可以被获取到，然后通过调用builder构建部分之后 再rebuild一次

##### *海：
> 我第一次看老师写的看不懂，把代码复制下来跑了一下，明白的七七八八，分别去了菜鸟教程和简书看看，一番比较还是老师写的最好。付费知识还是香啊！！啊哈哈哈哈哈
